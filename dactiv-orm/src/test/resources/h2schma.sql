...
create table tb_account_menu (id varchar(32) not null, leaf boolean, name varchar(255), type integer not null, fk_parent_id varchar(32), primary key (id))
create table tb_account_role (id varchar(32) not null, name varchar(255), primary key (id))
create table tb_account_role_menu (menu_id varchar(32) not null, role_id varchar(32) not null)
