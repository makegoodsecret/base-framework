...
public class TestDataDictonaryManagerFunction extends FunctionTestCaseSupport{
	...
	public void doTest() {
		...
		//打开添加页面
		s.click(By.xpath("//a[@href='/dactiv-base-curd/foundation/variable/data-dictionary/read']"));
		//填写表单
		...
		//点击下一页
		s.click(By.xpath("//a[@href='/dactiv-base-curd/foundation/variable/data-dictionary/view?pageNo=2']"));
		//点击编辑功能
